  ...
  return (
    <aside className="bg-blue-800 text-white w-64 min-h-screen p-4">
      ...
      <nav className="space-y-2">
        ...
        <p className="text-xs text-blue-300 px-4 py-1 uppercase font-semibold">Gestión de Usuarios</p>
        
        <Link 
          to="/admin?section=admin" 
          className={`flex items-center py-2.5 px-4 rounded transition ${
            location.search === "?section=admin" ? "bg-blue-900" : "hover:bg-blue-700"
          }`}
        >
        ...
        <Link 
          ...
          className={`flex items-center py-2.5 px-4 rounded transition ${
            location.search === "?section=controllers" ? "bg-blue-900" : "hover:bg-blue-700"
          }`}
        >
        ...
        <Link 
          ...
          className={`flex items-center py-2.5 px-4 rounded transition ${
            location.search === "?section=recruiters" ? "bg-blue-900" : "hover:bg-blue-700"
          }`}
        >
        ...
        <Link 
          ...
          className={`flex items-center py-2.5 px-4 rounded transition ${
            location.search === "?section=students" ? "bg-blue-900" : "hover:bg-blue-700"
          }`}
        >
        ...
        <div className="py-1 border-t border-blue-700 my-2"></div>
        <p className="text-xs text-blue-300 px-4 py-1 uppercase font-semibold">Servicios</p>
        ...
        <Link 
          ...
          className={`flex items-center py-2.5 px-4 rounded transition ${
            location.search === "?section=categories" ? "bg-blue-900" : "hover:bg-blue-700"
          }`}
        >
          <FiBookOpen className="mr-3" /> Categorías
        </Link>
